...
def main():
  ...
  model_factory = lambda: MLPRegressor(hidden_layer_sizes=(100, ))
  train_result = train_models(featurizers, model_factory=model_factory, verbose=True)
